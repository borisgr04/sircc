<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ReportP.aspx.vb" Inherits="Reportes_ParametrizadoR_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    <div class="demoarea">
        ...
        <asp:Label id="Tit" runat="server" Width="546px" CssClass="Titulo" > REPORTE PARAMETRIZADO POR RUBROS</asp:Label>
        <br />
        ...
        <asp:ObjectDataSource ID="ObjRptContratos" runat="server" 
            OldValuesParameterFormatString="original_{0}" SelectMethod="GenerarReportRub" 
            TypeName="Reportes">
            <SelectParameters>
