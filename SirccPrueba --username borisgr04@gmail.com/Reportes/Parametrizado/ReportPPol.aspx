<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ReportPPol.aspx.vb" Inherits="Reportes_ParametrizadoPol_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    <div class="demoarea">
        ...
        <asp:Label id="Tit" runat="server" Width="623px" CssClass="Titulo" > REPORTE PARAMETRIZADO Y CON POLIZAS DETALLADAS</asp:Label>
        <br />
        ...
        <asp:ObjectDataSource ID="ObjRptContratos" runat="server" 
            OldValuesParameterFormatString="original_{0}" SelectMethod="GenerarReportPol" 
            TypeName="Reportes">
            <SelectParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjRptContratos" 
