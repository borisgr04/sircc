<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="LegalizacionN.aspx.vb" Inherits="Contratos_LegalizacionN_Default" %>
...
<%@ Register src="../../CtrlUsr/GrdPolCN/grdPolCN.ascx" tagname="grdPolCN" tagprefix="uc8" %>

<%@ Register src="../../CtrlUsr/DetContratosN/DetContratoN.ascx" tagname="DetContratoN" tagprefix="uc9" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <uc8:grdPolCN ID="grdPolCN1" runat="server" />
        </div>
           </Content>
            </ajaxToolkit:AccordionPane>
