Imports System.Data
Partial Class DatosBasicos_Impuestos_Default
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ...
                GridView2.DataBind()
                ExportGridView(GridView2, "IMPUESTOS - SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Nro_Imp").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Nom_Imp").ToString
                    Me.CboEst.Text = tb.Rows(0)("Estado").ToString
                    Me.Txt_Cod_Pct.Text = tb.Rows(0)("Cod_Pct").ToString
                    Me.Pk1 = tb.Rows(0)("Nro_Imp").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, txtNomNew.Text, Txt_Cod_Pct.Text, CboEst.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Pk1, Me.TxtCodNew.Text, txtNomNew.Text, Txt_Cod_Pct.Text, CboEst.SelectedValue)
        End Select
