Imports System.Data
Partial Class DatosBasicos_CalcularVigPol_Default
    Inherits PaginaComun

    Dim Obj As New Cal_Vig_Pol
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_Cal").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Descripcion").ToString
                    Me.Pk1 = tb.Rows(0)("Cod_Cal").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
            ...
            Case "Eliminar"
                ...
                'MultiView1.ActiveViewIndex = 0
            Case "Exportar"
                ExportGridView(GridView1, "CalcularVigenciaPolizas-SIRCC")
        End Select
