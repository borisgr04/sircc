Imports System.Data
Partial Class DatosBasicos_TiposCont_Default
    Inherits PaginaComun

    Dim Obj As New Tipos
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ...
                GridView2.DataBind()
                ExportGridView(GridView2, "TIPOS_CONTRATOS-SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    ...
                    Me.txtNomNew.Text = tb.Rows(0)("Nom_Tip").ToString
