Imports System.Data
Partial Class CtrlUsr_grdCDP_grdCDPMod
...
#End Region
    ...
    Private Function GetRecords() As DataTable
        ...
        dt = obj.GetMod_CDP(Me.Num_Sol_Adi)
        Return dt
    End Function
    ...
    Protected Sub RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        If e.CommandName.Equals("AddNew") Then
            ...
            If IsNumeric(txtNewNro_Cdp.Text) And IsDate(txtNewFec_Cdp.Text) And IsNumeric(txtNewVal_Cdp.Text) Then
                Me.MsgResult.Text = obj.InsertCDP(Me.Num_Sol_Adi, txtNewNro_Cdp.Text, CDate(txtNewFec_Cdp.Text), Publico.PuntoPorComa(txtNewVal_Cdp.Text), Me.Cod_Con)
    ...
    Protected Sub RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles grd.RowDeleting
        Me.MsgResult.Text = obj.DeleteCDP(Me.grd.DataKeys(e.RowIndex).Values(0).ToString(), Me.Num_Sol_Adi)
        MsgBox(MsgResult, obj.lErrorG)
        grd.EditIndex = -1
        OnClick(sender)
        LlenarGrid()
    ...
    Protected Sub ChkModCDP_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ChkModCDP.CheckedChanged
        obj.Tras_CDP(Me.Cod_Con, Me.Num_Sol_Adi, Util.invN1_0(ChkModCDP.Checked))
        Me.LlenarGrid()
        Me.Enabled = ChkModCDP.Checked
    End Sub
End Class
