<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ConPContratosR.ascx.vb" Inherits="CtrlUsr_ConPContratos_ConPContratosR" %>
...
<uc1:FiltroPCon ID="FiltroPCon1" runat="server" />
    ...
    <asp:ObjectDataSource ID="ObjPContratos" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetProcesosDF" 
        TypeName="PContratos">
