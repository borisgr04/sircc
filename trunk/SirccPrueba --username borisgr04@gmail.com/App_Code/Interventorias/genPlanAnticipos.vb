...
Public Class genPlanAnticipos
    ...
    Function GenActa(ByVal Cod_Con As String, ByVal Ide_Pla As String, ByVal Ide_Acta As String) As String
        Try
            ...
            If dtConsulta.Rows.Count > 0 Then
                ...
                End If
                Dim dtTablaAnticipos As DataTable = GetPlanAnticipo(Ide_Acta)        '= '**GetCertificadoL() ' LISTA DEL CONTRATO
    ...
    <DataObjectMethodAttribute(DataObjectMethodType.Select, True)> _
    Private Overloads Function GetPlanAnticipo(ByVal Noid1 As String) As DataTable
    ...
    End Function
    <DataObjectMethodAttribute(DataObjectMethodType.Select, True)> _
    Public Overloads Function GetPlanAnticipoP(ByVal Noid1 As String) As DataTable
        Dim dataTb As DataTable
        Conectar()
        dataTb = GetPlanAnticipo(Noid1)
        Desconectar()
        Return dataTb
    End Function
