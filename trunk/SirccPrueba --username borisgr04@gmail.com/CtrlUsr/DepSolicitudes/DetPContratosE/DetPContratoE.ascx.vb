Imports System.Data
Partial Class Controles_DetPContratoE
...
#Region "Propiedades del control"
    ...
    Public Property CodigoPContrato() As String
        ...
        End Get
        Set(ByVal value As String)
            RadComboBox1.Text = value
            NumProc = value
            Buscar()
            OnClick(RadComboBox1)
            'End If
...
#Region "Métodos del control"
    ...
    ''' <remarks></remarks>
    Public Sub Buscar()
        'Me.CodigoPContrato = Me.RadComboBox1.SelectedValue
        Dim oP As New PContratos
        Me.dtContratos = oP.GetByPkE(Me.NumProc)
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            'Me.TxtCodCon.Text = ""
            Me.NumProc = Me.RadComboBox1.SelectedValue
        End If
    End Sub
    ...
    Protected Sub RadComboBox1_DataBound1(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadComboBox1.DataBound
