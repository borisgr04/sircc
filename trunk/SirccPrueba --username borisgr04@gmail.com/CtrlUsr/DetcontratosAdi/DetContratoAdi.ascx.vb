Imports System.Data
Partial Class Controles_DetContratoAdi
...
#Region "Propiedades del control"
    ...
    Public Property Grupo() As String
        ...
        End Set
    End Property
    Public Property IdSolAdi() As String
        Get
            Return ViewState("IdSolAdi")
        End Get
        Set(ByVal value As String)
            ViewState("IdSolAdi") = value
        End Set
    End Property
#End Region
...
#Region "Métodos del control"
    ...
    Public Sub Buscar()
        ...
        Me.IdSolAdi = Me.CboNumSol.SelectedValue
        Me.dtContratos = oSA.GetByPk(Me.Cod_Con, Me.IdSolAdi)
