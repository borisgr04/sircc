<%@ Control Language="VB" AutoEventWireup="false" CodeFile="grdObligMod.ascx.vb" Inherits="CtrlUsr_grdOblig_grdObligMod" %>
<p>
    <table style="width:100%;">
        <tr>
            <td>
                <asp:CheckBox ID="ChkModOblig" runat="server" AutoPostBack="True" 
                    Text="Modificar las Obligaciones" />
            </td>
            <td>
                &nbsp;</td>
            <td>
