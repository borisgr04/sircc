<%@ Page Language="VB" Title="" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="SolicitudesCord.aspx.vb" Inherits="Consultas_SolicitudesCord_SolicitudesCord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    ...
    <ContentTemplate>
    <uc1:FiltroSolP ID="FiltroSolP1" runat="server" />
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="FiltroSolP1" EventName="FiltrarClicked" />
            </Triggers>
        </asp:UpdatePanel>
        <br />
