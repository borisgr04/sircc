--DROP VIEW sircc.vlstcontratos;
/* Formatted on 2012/09/11 21:08 (Formatter Plus v4.8.8) */
CREATE OR REPLACE FORCE VIEW vlstcontratos AS
   SELECT numero, obj_con "OBJETO",
          TO_CHAR (fec_sus_con,
