<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Sector.aspx.vb" Inherits="DatosBasicos_Sector_Default" %>
...
<div class="demoarea">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
&nbsp;<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" Text="Sectores"></asp:Label><BR />
            <asp:Label id="MsgResult" runat="server" SkinID="MsgResult"></asp:Label>&nbsp;&nbsp;&nbsp;<BR />&nbsp;<asp:GridView 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Cod_Sec" 
...
<Columns>
<asp:TemplateField HeaderText="Código" SortExpression="Cod_Sec"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Cod_Sec") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre del Sector" SortExpression="Nom_Sec"><FooterTemplate>
...
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Nom_Sec") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Cod_Sec" 
                EmptyDataText="No se encontraron Registros en la Base de Datos" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código" SortExpression="Cod_Sec">
                        <ItemTemplate>
                            <asp:Label ID="LbCod0" runat="server" __designer:wfdid="w9" 
                                Text='<%# Bind("Cod_Sec") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre del Sector" SortExpression="Nom_Sec">
                        <ItemTemplate>
                            <asp:Label ID="Lbcimp0" runat="server" __designer:wfdid="w21" 
                                Text='<%# Bind("Nom_Sec") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="Sector" 
...
<!-- Mensaje de Salida--><BR /><asp:Button style="DISPLAY: none" id="hiddenTargetControlForModalPopup2" runat="server"></asp:Button> <ajaxToolkit:ModalPopupExtender id="ModalPopupTer" runat="server" PopupDragHandleControlID="programmaticPopupDragHandle2" PopupControlID="programmaticPopup2" DropShadow="True" BackgroundCssClass="modalBackground" BehaviorID="programmaticModalPopupBehavior2" RepositionMode="RepositionOnWindowScroll" TargetControlID="hiddenTargetControlForModalPopup2">
            ...
            <asp:Panel id="programmaticPopup2" runat="server" Width="406px" Height="303px" 
                CssClass="ModalPanel2"><asp:Panel id="programmaticPopupDragHandle2" runat="Server" Width="655px" Height="30px" CssClass="BarTitleModal2">
                    <DIV style="padding: 5px; VERTICAL-ALIGN: middle; width: 393px;">
                        <DIV 
                    style="FLOAT: left">
                            Sectores</DIV><DIV style="FLOAT: right">
                            <INPUT id="BtnCerrar" type=button value="X" /></DIV>
</DIV></asp:Panel>&nbsp;<TABLE align="center"><TBODY>
        <TR><TD colSpan=3>
        ...
        <TR><TD style="WIDTH: 98px; HEIGHT: 18px">
                <asp:Label ID="Label5" runat="server" Text="Estado" Width="126px"></asp:Label></TD>
