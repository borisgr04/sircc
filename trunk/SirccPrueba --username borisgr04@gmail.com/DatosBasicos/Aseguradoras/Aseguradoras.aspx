<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Aseguradoras.aspx.vb" Inherits="DatosBasicos_Aseguradoras_Default" %>
...
&nbsp;<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" 
                Text="Aseguradoras"></asp:Label><BR /><asp:Label id="MsgResult" 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Cod_Ase" 
...
<Columns>
<asp:TemplateField HeaderText="Código" SortExpression="Cod_Ase"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Cod_Ase") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre de la Aseguradora" SortExpression="Nom_Ase"><FooterTemplate>
...
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Nom_Ase") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Cod_Ase" 
                EmptyDataText="No se encontraron Registros en la Base de Datos" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Código" SortExpression="Cod_Ase">
                        <ItemTemplate>
                            <asp:Label ID="LbCod0" runat="server" __designer:wfdid="w9" 
                                Text='<%# Bind("Cod_Ase") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre de la Aseguradora" 
                        SortExpression="Nom_Ase">
                        <ItemTemplate>
                            <asp:Label ID="Lbcimp0" runat="server" __designer:wfdid="w21" 
                                Text='<%# Bind("Nom_Ase") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="Aseguradoras" 
                SelectMethod="GetRecordsDB" OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource><!-- <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White"></FooterStyle>-->
</contenttemplate>
        <Triggers>
...
<!-- Mensaje de Salida--><BR /><asp:Button style="DISPLAY: none" id="hiddenTargetControlForModalPopup2" runat="server"></asp:Button> <ajaxToolkit:ModalPopupExtender id="ModalPopupTer" runat="server" PopupDragHandleControlID="programmaticPopupDragHandle2" PopupControlID="programmaticPopup2" DropShadow="True" BackgroundCssClass="modalBackground" BehaviorID="programmaticModalPopupBehavior2" RepositionMode="RepositionOnWindowScroll" TargetControlID="hiddenTargetControlForModalPopup2">
            </ajaxToolkit:ModalPopupExtender>&nbsp;&nbsp;&nbsp;<asp:Panel id="programmaticPopup2" runat="server" Width="660px" Height="400px" CssClass="ModalPanel2"><asp:Panel id="programmaticPopupDragHandle2" runat="Server" Width="655px" Height="30px" CssClass="BarTitleModal2"><DIV style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; VERTICAL-ALIGN: middle; PADDING-TOP: 5px"><DIV style="FLOAT: left">
                            Aseguradoras</DIV><DIV style="FLOAT: right">
        ...
        <TR><TD style="WIDTH: 98px; HEIGHT: 18px">
                <asp:Label ID="Label5" runat="server" Text="Nombre" Width="126px"></asp:Label></TD>
        ...
        <TR><TD style="TEXT-ALIGN: center" colSpan=3><asp:Button id="BtnGuardar" runat="server" Text="Guardar"></asp:Button>&nbsp;<asp:Button id="BtnEliminar" runat="server" Text="Eliminar">
