<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="CalcularPol.aspx.vb" Inherits="DatosBasicos_CalcularPol_Default" %>
...
&nbsp;<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" 
                Text="Calculo de Polizas"></asp:Label><BR /><asp:Label id="MsgResult" 
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="CalculoPol" 
                SelectMethod="GetRecordsDB" OldValuesParameterFormatString="original_{0}" 
                UpdateMethod="Update">
                <UpdateParameters>
                    <asp:Parameter Name="Cod_Cal_O" Type="String" />
                    <asp:Parameter Name="Cod_Cal" Type="String" />
