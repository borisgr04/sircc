...
// ]]>
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
        DisplayMode="List" Width="90%" SkinID="ValidationSummary1" />
        
    <table border="0" class="tbcont" width="900px">
        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 101px; height: 10px">
                                <asp:Label ID="TxtUId" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="White"
                                    BackColor="Navy" Width="147px" __designer:wfdid="w3"></asp:Label>
                            </td>
                            <td style="width: 10px; height: 10px">
                                &nbsp;
                            </td>
                            <td style="width: 400px; height: 10px">
                                <asp:Label ID="TxtUFs" runat="server" __designer:wfdid="w3" BackColor="Navy" Font-Bold="True"
                                    Font-Size="Medium" ForeColor="White" Width="100%"></asp:Label>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <tr>
            <td colspan="6" style="height: 15px">
                ...
                <ajaxToolkit:ConfirmButtonExtender ID="BtnGuardar_ConfirmButtonExtender" 
                    ...
                    ConfirmText="Confirme FECHA DE SUSCRIPCIÓN. ¿Desea Radicar el Contrato/Convenio?" 
                    ...
                    <tr>
                        <td style="width: 238px; height: 10px">
                            <asp:DropDownList ID="CboTip" runat="server" AutoPostBack="True" DataSourceID="ObjTiposCont"
                                DataTextField="NOM_TIP" DataValueField="COD_TIP" Height="16px" 
                                Width="209px">
                            </asp:DropDownList></td>
    ...
    <asp:TextBox ID="TxtCodCon" runat="server" Width="110px" Font-Bold="True" Font-Size="12pt" 
                    ...
                    <tr>
                        <td style="height: 10px" colspan="9">
                            <asp:Label ID="TipoRad" runat="server" CssClass="SubTitulo" Height="16px" 
        ...
        <tr>
            <td class="TbLogin" colspan="3" style="height: 15px">
                SubTipo de Contrato</td>
            <td class="STitulos" colspan="3" style="height: 15px">
        Fecha de Suscripción<asp:RequiredFieldValidator ID="RequiredFieldValidator18" 
                    runat="server" ControlToValidate="TxtFsus"
                    ErrorMessage="Digite Fecha de Suscripción" Width="52px">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td  colspan="3" style="height: 15px">
                <asp:UpdatePanel id="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    ...
                    <asp:DropDownList id="cboStip" runat="server" DataValueField="COD_STIP" DataTextField="NOM_STIP"
                     DataSourceID="ObjSubTipos" Width="80%" ></asp:DropDownList> 
</contenttemplate>
                                <triggers>
<asp:AsyncPostBackTrigger ControlID="CboTip" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
            ...
            <asp:UpdatePanel id="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:TextBox ID="TxtFsus" runat="server" Font-Bold="True" Font-Size="12pt" 
                                        Width="135px"></asp:TextBox>
                                    (dd/mm/aaaa)
                                       <ajaxToolkit:CalendarExtender ID="TxtFsus_CalendarExtender" 
                                                runat="server" Enabled="True" TargetControlID="TxtFsus">
...
<asp:AsyncPostBackTrigger ControlID="CboTip" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
        ...
        <tr>
            <td class="STitulos" colspan="3" style="height: 15px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtObj"
                    ErrorMessage="Digite Objeto del Contrato/Convenio" Width="16px">*</asp:RequiredFieldValidator></td>
            <td class="STitulos" colspan="3" style="height: 15px">
                &nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" style="height: 14px" class="STitulos">
                Contratista<asp:RequiredFieldValidator ID="RequiredFieldValidator5" 
                    runat="server" ControlToValidate="TxtIde" ErrorMessage="Seleccione Contratista" 
                    Width="52px">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 141px">
                            <asp:TextBox ID="TxtIde" runat="server" AutoPostBack="True" CssClass="txt" 
                        ...
                        <td>
                            <asp:TextBox ID="TxtNom" runat="server" CssClass="txt" ReadOnly="True" 
                                Width="100%"></asp:TextBox>
                            <ajaxToolkit:FilteredTextBoxExtender ID="TxtIde_FilteredTextBoxExtender1" 
                                runat="server" Enabled="True" FilterType="Numbers" TargetControlID="TxtIdeRlc" 
                                ValidChars="">
                    ...
                    <tr>
                        <td class="STitulos" colspan="5">
                            Representante Legal del Contrato<asp:RequiredFieldValidator 
                                ID="RequiredFieldValidator14" runat="server" ControlToValidate="TxtIdeRlc" 
                                ErrorMessage="Seleccione Representante Legal" Width="22px">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 141px">
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="TxtNomRlc" runat="server" CssClass="txt" ReadOnly="True" 
                                Width="100%"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
        ...
        <tr>
            <td colspan="6" valign="top" class="STitulos">
                Dependencia que Genera la Necesidad<asp:Label ID="Label6" runat="server" 
                    ForeColor="Red" Text="*" Width="13px"></asp:Label>
                &nbsp;</td>
        </tr>
        <tr>
            <td colspan="6" valign="top">
                <asp:DropDownList ID="CboDep" runat="server" CssClass="txt" 
                    DataSourceID="ObjDep" DataTextField="NOM_DEP" DataValueField="COD_DEP">
        ...
        <tr>
            <td style="height: 10px" valign="top" colspan="6">
                <table width="100%">
                    <tr class="STitulos">
                        <td>
                            Valor Total<asp:RequiredFieldValidator ID="RequiredFieldValidator19" 
                                runat="server" ControlToValidate="TxtVal" 
                                ErrorMessage="Valor del Contrato requerido" Height="16px" Width="16px">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
                            Aportes Propios<asp:RequiredFieldValidator ID="RequiredFieldValidator20" 
                                runat="server" ControlToValidate="TxtValProp" 
                                ErrorMessage="Aportes Propios Requeridos" Height="16px" Width="16px">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
                            Aportes Otros</td>
                        <td>
        ...
        <tr>
            <td class="STitulos" colspan="6" style="height: 10px;" valign="top">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                    ControlToValidate="TxtPla" ErrorMessage="Plazo de Ejecución Requerido" 
                    Height="16px" Width="16px">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="height: 10px" valign="top" colspan=6>
                        ...
                        <tr>
                            <td>
                                ...
                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" 
                                    runat="server" FilterType="Numbers" TargetControlID="TxtPla">
                                </ajaxToolkit:FilteredTextBoxExtender>
                            </td>
                            <td>
                                <asp:DropDownList ID="CboTPlazo" runat="server" AutoPostBack="true" 
                                    DataSourceID="Tipo_Plazos" DataTextField="Nom_Pla" DataValueField="Cod_TPla" 
                                    Width="92px">
                                </asp:DropDownList>
                            </td>
                            <td>
                                ...
                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" 
                                    runat="server" FilterType="Numbers" TargetControlID="TxtPlazo2">
                                </ajaxToolkit:FilteredTextBoxExtender>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="ChkAgotarPpto" runat="server" 
                                    Text="Hasta Agotar Presupuesto" />
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            ...
            <td class="STitulos" style="width: 115px; height: 10px" valign="top">
                N° Proyecto</td>
            <td style="width: 92px; height: 10px" valign="top" class="STitulos">
                Forma Contractual</td>
            <td colspan="2" style="height: 10px" class="STitulos">
                &nbsp;&nbsp;</td>
            <td class="STitulos">
                &nbsp;&nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="width: 115px; height: 10px" colspan="2">
                ...
                <ajaxToolkit:FilteredTextBoxExtender ID="TxtNEmpleos_FilteredTextBoxExtender" 
                    runat="server" Enabled="True" FilterType="Numbers" 
                    TargetControlID="TxtNEmpleos">
                </ajaxToolkit:FilteredTextBoxExtender>
            </td>
        ...
        <tr>
            <td  colspan="6" style="height: 10px" valign="top">
                <table cellpadding="10" width="100%" >
                    <tr class="STitulos">
                    <td> MUNICIPIOS Y/O CORREGIMIENTOS                   </td>
                    <td>CERTIFICADO DE DISPONIBILIDAD PPTAL</td>
                    <td> PROYECTOS</td>
                    </tr>
                    <tr>
                        ...
                        <div ID="DIV1" language="javascript" style="z-index: 101; overflow: auto; width: 237px;
                            ...
                            <asp:DataList ID="DataList1" runat="server" CellPadding="4" CellSpacing="5" 
                                ...
                                <ItemTemplate>
                                    &nbsp;<asp:CheckBox ID="chknommun" runat="server" Checked='<%# eval("est") %>' 
                                        Text='<%# Eval("NOM_MUN") %>' />
                                    <asp:TextBox ID="txtcodmun" runat="server" Text='<%# Eval("COD_MUN") %>' 
                                        Visible="False" Width="197px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:DataList>
                            </div>
                        </td>
        ...
        <tr>
            <td colspan="3" style="height: 9px">
                <asp:TextBox ID="TxtCsor" runat="server" Height="60px" TextMode="MultiLine" 
        ...
        <tr>
            ...
            <td colspan="6" style="height: 15px; margin-left: 40px;">
            </td>
        </tr>
    </table>
                        <ajaxToolkit:FilteredTextBoxExtender ID="TxtIde_FilteredTextBoxExtender0" 
                            runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtide" 
                            ValidChars="">
                        </ajaxToolkit:FilteredTextBoxExtender>
    <br />
...
runat="server" BackgroundCssClass="modalBackground" BehaviorID="programmaticModalPopupBehavior" DropShadow="True" PopupControlID="programmaticPopup" PopupDragHandleControlID="programmaticPopupDragHandle" RepositionMode="RepositionOnWindowScroll" TargetControlID="hiddenTargetControlForModalPopup">
            ...
            <asp:Panel id="programmaticPopup" runat="server" Width="693px" Height="555px" 
    ...
    <asp:ObjectDataSource ID="ObjConMun" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetConMun" 
        TypeName="Contratos">
        <SelectParameters>
