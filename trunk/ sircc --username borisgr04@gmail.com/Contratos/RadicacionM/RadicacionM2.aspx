<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="RadicacionM2.aspx.vb" Inherits="Contratos_RadicacionM2_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="Server">
    ...
    <div class="demoarea">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                ...
                <table border="0" width="90%">
                    ...
                    <table>
                    <tr>
                        <td class="TbLogin" colspan="2" style="height: 15px">
                            N° de Proceso</td>
                        <td class="TbLogin" colspan="2" style="height: 15px">N° Grupo</td>
                        ...
                        <tr>
                            <td  colspan="2" style="height: 15px">
                                <asp:TextBox ID="TxtNProc" runat="server"  AutoPostBack="True" Width="142px"></asp:TextBox>
                            </td>
                            <td colspan="2" style="height: 15px">
                                <asp:DropDownList ID="CboGrupos" runat="server" AutoPostBack="True" DataSourceID="ObjGrupos" DataTextField="Grupos" DataValueField="Grupo" Width="100px">
                                </asp:DropDownList>
                                <asp:ImageButton ID="BtnBuscar" CausesValidation="false" runat="server" SkinID="IBtnBuscar" />
                            </td>
                            <td  colspan="3" style="height: 15px">
                                <asp:DropDownList ID="CboTproc" runat="server" CssClass="txt" DataSourceID="ObjTipoProc" DataTextField="NOM_TPROC" DataValueField="COD_TPROC" ToolTip="Proceso PreContractual">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="TbLogin" colspan="4" style="height: 15px">SubTipo de Contrato </td>
                            <td class="STitulos" colspan="3" style="height: 15px">Fecha de Suscripción<asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="TxtFsus" ErrorMessage="Digite Fecha de Suscripción" Width="52px">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td class="STitulos" colspan="4" style="height: 15px">
                            Objeto del Contrato
                    ...
                    <tr>
                        <td colspan="7" style="height: 14px" class="STitulos">
                    ...
                    <tr>
                        <td colspan="7" valign="top" class="STitulos">
                    ...
                    <tr>
                        <td class="STitulos" colspan="4" valign="top">
                    ...
                    <tr>
                        <td class="STitulos"  colspan="7" valign="top">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td style="height: 10px" valign="top" colspan="7">
                                <table width="100%">
                                    <tr class="STitulos">
                                        <td>
                    ...
                    <tr>
                        <td class="STitulos" colspan="7" style="height: 10px;" valign="top">
                    ...
                    <tr>
                        ...
                        <td class="STitulos" style="width: 115px; height: 10px" valign="top" colspan="2">
                            N° Proyecto
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 115px; height: 8px" valign="top" colspan="2">
                        ...
                        <td style="width: 146px">
                            <asp:CheckBox ID="ChkUM" runat="server" Text="Urgencia Manifiesta" Visible="False" Width="157px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="STitulos" style="width: 115px; height: 10px" colspan="3">
                            N° de Empleos
                        </td>
                    ...
                    <tr>
                        <td style="width: 115px; height: 10px" colspan="3">
                        ...
                        <td style="width: 146px">
                            &nbsp;
                            <asp:TextBox ID="TxtPlapre" visible="false" runat="server" CssClass="txt"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="7" style="height: 10px" valign="top">
                    ...
                    <tr>
                        <td style="width: 115px; height: 10px" valign="top" colspan="3">
                        </td>
        ...
        <asp:ObjectDataSource ID="ObjGrupos" runat="server" 
            ...
            TypeName="Grupos">
            <SelectParameters>
                <asp:ControlParameter ControlID="TxtNProc" Name="Num_Proc" 
