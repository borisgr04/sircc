        ...
        $(function () {
        	...
        	{ contentType: 'application/json; charset=utf-8' }
                ...
                var linkrenderer = function (row, column, value) {
                    ...
                    var html = $.jqx.dataFormat.formatlink("GesContratos.aspx?CodCon=" + value, format);
                    return html;*/
                    return '<a href="GesContratos.aspx?CodCon=' + value+'" target=_blank/>' + value + '</a>'
                };
                // initialize jqxGrid
                $("#jqxgridD").jqxGrid(
            {
                ...
                /*
                $("#jqxgridD").bind('rowselect', function (event) {

                var selectedRowIndex = event.args.rowindex;
                var cell = $('#jqxgridD').jqxGrid('getcell', selectedRowIndex, 'NUMERO');

                //alert(cell.value);
                self.location.href = "GesContratos.aspx?CodCon=" + cell.value;
