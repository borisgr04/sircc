<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TerminarContratos.aspx.vb" Inherits="TerminarContratos_Default" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                ...
                <asp:Label ID="Label1" runat="server" CssClass="Titulo" 
                    Text="TERMINACÓN DE CONTRATOS"></asp:Label>
