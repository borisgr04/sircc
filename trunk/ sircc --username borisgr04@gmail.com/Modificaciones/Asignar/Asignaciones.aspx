<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Asignaciones.aspx.vb" Inherits="SolAdiciones_Asignaciones_Default" %>
            ...
            <br />
                  <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
                    ...
                    AutoGenerateColumns="False" Width="555px">
                                    <Columns>
                                        <asp:BoundField DataField="Num_Sol_Adi" HeaderText="Código" />
                                        <asp:BoundField DataField="Fec_Reg" HeaderText="Fecha de Registro" ItemStyle-Width="150" />
                                    ...
                                    <EmptyDataTemplate>
                                        No se ha asignado la Solicitud de Modificación
                                    </EmptyDataTemplate>
                                </asp:GridView>
            </asp:Panel>
            <br />
...
&nbsp;</div>
                ...
                <uc1:ConsultaTerxDep ID="ConsultaTerxDep" runat="server" />
                <br />
