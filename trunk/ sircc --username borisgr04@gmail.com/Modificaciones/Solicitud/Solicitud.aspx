<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Solicitud.aspx.vb" Inherits="Modificaciones_Solicitud_Solicitud" %>
                ...
                <tr>
                    ...
                    <td style="width: 115px">
                        <asp:DropDownList ID="CboNumSol" runat="server" DataSourceID="ObjSolAdi" 
                            DataTextField="Nom_Tip" DataValueField="Num_Sol_Adi" Width="170px">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 47px">
                    ...
                    <td>
                        <asp:LinkButton ID="BtnAsignar" runat="server">Ir a Asignaciones</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td style="width: 41px">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="width: 350px">
                        <asp:TextBox ID="TxtNProc" runat="server" BackColor="#000066" Font-Size="12pt" 
                            ForeColor="White" ReadOnly="True" Width="180px"></asp:TextBox>
                        <ajaxToolkit:TextBoxWatermarkExtender ID="TxtNProc_TextBoxWatermarkExtender" 
                            runat="server" Enabled="True" TargetControlID="TxtNProc" 
                            WatermarkCssClass="watermarked" WatermarkText="Automático ">
                        </ajaxToolkit:TextBoxWatermarkExtender>
                    </td>
                    <td style="width: 139px">
                        <asp:Label ID="LblEstado" runat="server" CssClass="selectIndex"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
