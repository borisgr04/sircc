<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Contratos.aspx.vb" Inherits="Consultas_ContratosSGR_Contratos" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<%@ Register src="../../CtrlUsr/DetContratosN/DetContratoN.ascx" tagname="DetContratoN" tagprefix="uc1" %>
<%@ Register src="../../CtrlUsr/grdAdiC/grdAdiC.ascx" tagname="grdAdiC" tagprefix="uc4" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <Panes>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Fec_Rp" HeaderText="Fecha RP" DataFormatString="{0:d}"/>
                    <asp:BoundField DataField="Val_RP" HeaderText="Valor RP" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField DataField="Vigencia" HeaderText="Vigencia del RP" ItemStyle-HorizontalAlign="Right"/>
                    <asp:BoundField DataField="Doc_Sop" HeaderText="Documento de Soporte"/>
                </Columns>
            </asp:GridView>
                </Content>
        ...
        GridLines="None" HeaderText="DETALLE"
            ...
            <ajaxToolkit:AccordionPane ID="AccordionPane11" runat="server">
                <Header><a href="#" class="accordionLink"> 12. MODIFICATORIOS </a></Header>
                <Content>
        ...
        ShowFooter="True" DataSourceID="ObjMod">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Plazo de Ejecución(dias)">
                <ItemTemplate>
            ...
            <asp:GridView ID="grdPagos" runat="server" AllowSorting="True" 
               ...
               ShowFooter="True" DataSourceID="ObjPagos">
          <Columns>
            ...
            <asp:ObjectDataSource ID="ObjPagos" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetPagos" 
                TypeName="CtrEgresosSIIAF">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DetContratoN1" Name="Cod_Con" 
                        PropertyName="Cod_Con" Type="String" />
                </SelectParameters>
            </asp:ObjectDataSource>
            <asp:ObjectDataSource ID="ObjMod" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetRecordsUlt" 
                TypeName="Adiciones">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DetContratoN1" Name="Cod_Con" 
                        PropertyName="Cod_Con" Type="String" />
