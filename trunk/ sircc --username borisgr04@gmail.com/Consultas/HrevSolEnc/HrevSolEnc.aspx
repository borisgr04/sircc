<%@ Page Language="VB" Title="" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="HrevSolEnc.aspx.vb" Inherits="Consultas_HrevSolEnc" %>
...
<%@ Register src="../../CtrlUsr/DepSolicitudes/ConPSolicitudes.ascx" tagname="ConPSolicitudes" tagprefix="uc3" %>
    ...
    <div class="demoarea">
     ...
     <div class="demoheading">REPORTE DE HISTORIAL DE REVISIONES DE SOLICITUDES</div>
        ...
        <asp:ObjectDataSource ID="ObjHrev" runat="server" 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="ValFiltro" Name="Cod_Sol" PropertyName="Value" 
                    Type="String" />
            </SelectParameters>
        ...
        <asp:Panel ID="PanelSolicitudes" runat="server" BackColor="White" Width="650px">
            ...
            <asp:Panel ID="PnAreaT" ScrollBars="Both" runat="server" Height="473px">
              <%--  <uc4:ConPSolicitudes ID="ConPSolicitudes1" runat="server" />--%>

                <uc3:ConPSolicitudes ID="ConPSolicitudes1" runat="server" />
