<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Contraloria_F201A.aspx.vb" Inherits="Reportes_Contraloria_F201A_Default" %>
...
<table style="background-color: lavender; width: 99%;" cellpadding="5" 
        ...
        <tr>
            <td colspan="4" style="text-align: center">
                <asp:Button ID="Generar_Reporte" runat="server" Text="Generar Reporte Excel" 
                    ToolTip="Export Directamente a Excel sin formato" /></td>
        </tr>
    </table>
<table cellpadding="2">
        <tr>
...
<asp:AsyncPostBackTrigger ControlID="CboTip" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
    ...
    <asp:Button ID="BtnExport" runat="server" Text="Exportar a Excel" />
        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjContratosF20" 
            SkinID="SinFormato" Visible="False">
        </asp:GridView>
