Imports System.Data
Partial Class Reportes_Contraloria_F201A_Default
    ...
    Protected Sub Generar_Reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Generar_Reporte.Click
        ...
        Me.HdSql.Value = Sql()
        GridView1.DataBind()
        'Response.Redirect("Report.aspx?sql=" + Server.UrlEncode(Sql()) & "&tit=" + Server.UrlEncode(txtTitulo.Text) & "&Rpte=" + Server.UrlEncode(Me.ChkGDep.Checked))
    End Sub
    ...
    Protected Function Sql() As String
        ...
        ''Modificación 18 de Febrero 2011
    ...
    Protected Sub BtnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExport.Click
        ExportGridView(GridView1, "Formato20_1A")
    End Sub
