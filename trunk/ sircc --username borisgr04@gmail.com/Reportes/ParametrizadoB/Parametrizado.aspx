<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Parametrizado.aspx.vb" Inherits="Reportes_ParametrizadoB_Parametrizado" %>
...
<table >
        <tr>
            <th class="filaR" colspan="5">
                1. AGRUPAR LISTADO DEL REPORTE POR: </th>
        </tr>
        <tr>
            <td colspan="5">
                <asp:RadioButtonList ID="rdGroup" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Selected="True" Value="sb" >Sin Agrupar</asp:ListItem>
        ...
        <tr>
            <th class="filaR" colspan="5">
                2. SELECCIONE LOS CAMPOS PARA REALIZAR EL FILTRO DE CONTRATOS</th>
        </tr>
        <tr class="filaR">
...
<asp:AsyncPostBackTrigger ControlID="CboTip" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
        ...
        <tr class="filaR">
            ...
            <td style="width: 150px; height: 24px" valign="top">
                <asp:CheckBox ID="ChkEst" runat="server" Font-Bold="False" Text="Ultima Acta" />
            </td>
            <td style="width: 161px; height: 24px" valign="top">
                <asp:CheckBox ID="ChkEst0" runat="server" Font-Bold="False" Text="Estado" />
            </td>
            <td style="width: 161px; height: 24px" valign="top">
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="height: 24px" valign="top">
                <asp:DropDownList ID="CboEstados" runat="server" DataSourceID="ObjEstActasD" 
                    DataTextField="estado" DataValueField="estado" Font-Size="8pt">
                </asp:DropDownList>
            </td>
            <td style="width: 161px; height: 24px" valign="top">
                &nbsp;</td>
        ...
        <tr>
            <td colspan="5" style="height: 10px">
                <asp:TextBox ID="TxtObj" placeholder="Digite Objeto a Buscar" runat="server" TextMode="MultiLine" Width="100%" 
...
runat="server" BackgroundCssClass="modalBackground" BehaviorID="programmaticModalPopupBehavior" DropShadow="True" PopupControlID="programmaticPopup" PopupDragHandleControlID="programmaticPopupDragHandle" RepositionMode="RepositionOnWindowScroll" TargetControlID="hiddenTargetControlForModalPopup">
    ...
    <asp:ObjectDataSource ID="ObjEstActasD" runat="server" 
                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetRecordsD" 
                    TypeName="EstadosC"></asp:ObjectDataSource>        
