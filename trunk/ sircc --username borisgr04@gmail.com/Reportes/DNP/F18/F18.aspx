<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="F18.aspx.vb" Inherits="Reportes_DNP_F18" %>
...
<table style="width: 99%;" cellpadding="5" 
        ...
        <tr>
        <td colspan="4">
        <asp:Label id="Tit" runat="server" CssClass="Titulo" > REPORTE DNP FORMATO 18</asp:Label>
        </td>
        </tr>
        <tr>
