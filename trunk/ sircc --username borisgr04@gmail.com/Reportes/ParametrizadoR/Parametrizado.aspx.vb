Imports System.Data
Partial Class Reportes_ParametrizadoR_Default
    ...
    Protected Sub Generar_Reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Generar_Reporte.Click
        ...
        Response.Redirect("ReportP.aspx?sql=" + Server.UrlEncode(Sql()) & "&tit=" + Server.UrlEncode(txtTitulo.Text) & "&Rpte=" + Server.UrlEncode(Me.rdGroup.SelectedValue))
    End Sub
    ...
    Protected Function Sql() As String
        ...
        strsql = "SELECT c.*,Cant_Adicion(c.numero) nro_adi,Plazo_Adicion(c.numero) Pla_Adi,Valor_Adicion(c.numero) Val_Adi FROM VCONTRATOS_SINC_P_R c " + cFiltro + " ORDER BY numero"
        Return strsql
    End Function
