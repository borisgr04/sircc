Imports System.Data
Partial Class DatosBasicos_Sector_Default
    Inherits PaginaComun

    Dim Obj As New Sector
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ...
                GridView2.DataBind()
                ExportGridView(GridView2, "SECTORES - SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_Sec").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Nom_Sec").ToString
                    Me.CboEst.Text = tb.Rows(0)("estado").ToString
                    Me.Pk1 = tb.Rows(0)("Cod_Sec").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
