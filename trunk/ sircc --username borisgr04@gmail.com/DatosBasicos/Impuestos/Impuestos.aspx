<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Impuestos.aspx.vb" EnableEventValidation="false" Inherits="DatosBasicos_Impuestos_Default" %>
...
<div class="demoarea">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
&nbsp;<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" Text="Impuestos"></asp:Label><BR />
            <asp:Label id="MsgResult" runat="server" SkinID="MsgResult"></asp:Label>&nbsp;&nbsp;&nbsp;<BR />&nbsp;<asp:GridView 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Nro_Imp" 
...
<Columns>
<asp:TemplateField HeaderText="Número" SortExpression="Nro_Imp"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Nro_Imp") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre del Impuesto" SortExpression="Nom_Imp"><FooterTemplate>
...
<asp:Label id="Lbcimp" runat="server" Text='<%# Bind("Nom_Imp") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
    <asp:TemplateField HeaderText="Estado" SortExpression="Estado">
    <ItemTemplate>
<asp:Label id="LbEst" runat="server" Text='<%# Bind("Estado") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
    </asp:TemplateField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Nro_Imp" 
                EmptyDataText="No se encontraron Registros en la Base de Datos" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Número" SortExpression="Nro_Imp">
                        <ItemTemplate>
                            <asp:Label ID="LbCod0" runat="server" __designer:wfdid="w9" 
                                Text='<%# Bind("Nro_Imp") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre del Impuesto" SortExpression="Nom_Imp">
                        <ItemTemplate>
                            <asp:Label ID="Lbcimp0" runat="server" __designer:wfdid="w21" 
                                Text='<%# Bind("Nom_Imp") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Estado" SortExpression="Estado">
                        <ItemTemplate>
                            <asp:Label ID="LbEst0" runat="server" __designer:wfdid="w21" 
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="Impuestos" 
                SelectMethod="GetRecordsDB" OldValuesParameterFormatString="original_{0}" 
                InsertMethod="Insert" UpdateMethod="Update">
                <InsertParameters>
                    <asp:Parameter Name="Nro_Imp" Type="String" />
                    <asp:Parameter Name="Nom_Imp" Type="String" />
                    <asp:Parameter Name="Cod_Pct" Type="String" />
                    <asp:Parameter Name="Estado" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="Nro_Imp_O" Type="String" />
                    <asp:Parameter Name="Nro_Imp" Type="String" />
                    <asp:Parameter Name="Nom_Imp" Type="String" />
                    <asp:Parameter Name="Cod_Pct" Type="String" />
                    <asp:Parameter Name="Estado" Type="String" />
...
<!-- Mensaje de Salida--><BR /><asp:Button style="DISPLAY: none" id="hiddenTargetControlForModalPopup2" runat="server"></asp:Button> <ajaxToolkit:ModalPopupExtender id="ModalPopupTer" runat="server" PopupDragHandleControlID="programmaticPopupDragHandle2" PopupControlID="programmaticPopup2" DropShadow="True" BackgroundCssClass="modalBackground" BehaviorID="programmaticModalPopupBehavior2" RepositionMode="RepositionOnWindowScroll" TargetControlID="hiddenTargetControlForModalPopup2">
            ...
            <asp:Panel id="programmaticPopup2" runat="server" Width="409px" Height="304px" 
                CssClass="ModalPanel2"><asp:Panel id="programmaticPopupDragHandle2" runat="Server" Width="655px" Height="30px" CssClass="BarTitleModal2">
                    <DIV style="padding: 5px; VERTICAL-ALIGN: middle; width: 401px;"><DIV style="FLOAT: left">
                            Impuestos</DIV><DIV style="FLOAT: right">
        ...
        <TR><TD style="WIDTH: 98px">
                <asp:Label id="Label4" runat="server" Width="143px" Text="Numero" 
                    __designer:wfdid="w19"></asp:Label></TD>
            <TD style="WIDTH: 100px"><asp:TextBox ID="TxtCodNew" runat="server" Height="21px"></asp:TextBox></TD>
        ...
        <TR><TD style="WIDTH: 98px; HEIGHT: 23px">
            ...
            <TD style="WIDTH: 100px; HEIGHT: 23px">
                    <asp:TextBox ID="txtNomNew" runat="server" Height="21px"></asp:TextBox></TD>
            <TD style="WIDTH: 100px; HEIGHT: 23px">
        ...
        <TR><TD style="WIDTH: 98px; HEIGHT: 18px">
                <asp:Label ID="Label6" runat="server" Text="Codigo SIIAF -PCT" Width="126px"></asp:Label>
                    </TD><TD style="WIDTH: 100px; HEIGHT: 18px">
                        <asp:TextBox ID="Txt_Cod_Pct" runat="server" Height="21px"></asp:TextBox>
