Imports System.Data
Partial Class DatosBasicos_Polizas_Default
    Inherits PaginaComun
    Dim Obj As New Municipios

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Tit.Text = "REGIONES (MUNICIPIOS / CORREGIMIENTOS)"
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ExportGridView(GridView1, "REGIONES - SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_Mun").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Nom_Mun").ToString

                    Me.Pk1 = tb.Rows(0)("Cod_Mun").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Pk1, Me.TxtCodNew.Text, txtNomNew.Text)
        End Select
