<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="TiposCont.aspx.vb" Inherits="DatosBasicos_TiposCont_Default" %>
...
<asp:Label id="MsgResult" runat="server" SkinID="MsgResult"></asp:Label>&nbsp;&nbsp;&nbsp;<BR />&nbsp;<asp:GridView 
                ...
                OnRowCommand="GridView1_RowCommand" DataKeyNames="Cod_Tip" 
...
<Columns>
<asp:TemplateField HeaderText="Código" SortExpression="Cod_Tip"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Cod_Tip") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre del Tipo" SortExpression="Nom_Tip"><FooterTemplate>
...
<asp:TemplateField HeaderText="Estado" SortExpression="Est_Tip"><ItemTemplate>
<asp:Label id="LbEst" runat="server" Text='<%# Bind("Est_Tip") %>' __designer:wfdid="w22"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre del Tipo" SortExpression="Nom_Tip">
                        <ItemTemplate>
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="Tipos" 
