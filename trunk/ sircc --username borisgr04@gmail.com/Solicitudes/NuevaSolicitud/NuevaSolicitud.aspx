<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" EnableEventValidation="true"
    AutoEventWireup="false" CodeFile="NuevaSolicitud.aspx.vb" Inherits="Procesos_NuevaSolicitud_Default" %>
...
<%@ Register Src="../../CtrlUsr/Solicitudes/ConPSolicitudesPK.ascx" TagName="ConPSolicitudesPK"
    TagPrefix="uc3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="Server">
    <div class="demoarea">
        ...
        <br />
        <asp:Label ID="Label10" runat="server" CssClass="Titulo" Text="REGISTRO DE SOLICITUDES"></asp:Label>
        <br />
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 53px">
                            <asp:ImageButton ID="IBtnNuevo" runat="server" Height="32px" SkinID="IBtnNuevo" Width="32px" />
                        </td>
                        <td style="width: 47px">
                        ...
                        <td style="width: 43px; text-align: center;">
                            <asp:ImageButton ID="IBtnGuardar" runat="server" Height="32px" SkinID="IBtnGuardar"
                                Width="32px" ValidationGroup="GUARDAR" Style="text-align: center" />
                            <cc1:ConfirmButtonExtender ID="IBtnGuardar_ConfirmButtonExtender" runat="server"
                                ConfirmText="Confirme si desea Guardar los Cambios?" Enabled="True" TargetControlID="IBtnGuardar">
                            </cc1:ConfirmButtonExtender>
                        </td>
                        <td style="width: 44px; text-align: center;" class="style1">
                            <asp:ImageButton ID="IBtnCancelar" runat="server" Height="32px" Width="32px" SkinID="IBtnCancelar" />
                        </td>
                        <td style="width: 87px; text-align: center">
                            <asp:ImageButton ID="BtnReabrir" runat="server" Height="32px" Width="32px" Enabled="False"
                                SkinID="IBtnReabrir" />
                        </td>
                        <td style="width: 68px">
                ...
                <table border="0px" cellpadding="2px" cellspacing="2px" style="width: 90%;">
                    <tr>
                        <td colspan="4">
                            <asp:Label ID="Label12" runat="server" Text="DATOS BASICOS DE LA SOLICITUD" CssClass="SubTitulo"></asp:Label>
                        </td>
                        <td>
                            <b>
                    ...
                    <tr>
                        <td style="width: 234px; height: 23px;">
                            <b>
                                <asp:Label ID="Label5" runat="server" Text="Número de la Solicitud" CssClass="Caption"></asp:Label>
                            </b>
                        </td>
                        <td style="width: 132px; height: 23px;">
                            <b>
                                <asp:Label ID="Label6" runat="server" CssClass="Caption" Text="Planeación Precontractual/Estudio Previo"></asp:Label>
                            </b>
                        </td>
                        <td colspan="2" style="height: 23px">
                            <b>
                                <asp:Label ID="Label15" runat="server" CssClass="Caption" Text="Fecha de Recibido"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtFechaRecibido"
                    ...
                    <tr>
                        <td style="width: 234px; height: 23px;">
                            <asp:TextBox ID="TxtNProc" runat="server" BackColor="#ACC4F9" Font-Size="12pt" ForeColor="White"
                                ReadOnly="True" Width="180px"></asp:TextBox>
                            <cc1:TextBoxWatermarkExtender ID="TxtNProc_TextBoxWatermarkExtender" runat="server"
                                Enabled="True" TargetControlID="TxtNProc" WatermarkCssClass="watermarked" WatermarkText="Automático ">
                        ...
                        <td colspan="2" style="height: 23px">
                            ...
                            <cc1:CalendarExtender ID="CalFechaRecibido" runat="server" Format="dd/MM/yyyy" TargetControlID="TxtFechaRecibido">
                    ...
                    <tr>
                        <td style="width: 234px; height: 23px;">
                            <b>
                                <asp:Label ID="Label8" runat="server" CssClass="Caption" Text="Tipo de Documento Contractual"></asp:Label>
                            </b>
                        </td>
                        <td style="width: 132px; height: 23px;">
                            <b>
                                <asp:Label ID="Label9" runat="server" CssClass="Caption" Text="Tipo de Contratación"></asp:Label>
                            </b>
                        </td>
                        <td colspan="2" style="height: 23px">
                            <b>
                                <asp:Label ID="Label21" runat="server" CssClass="Caption" Text="Valor Presupuesto Oficial"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtPpto"
                                    ErrorMessage="Debe diligenciar el Presupuesto" ValidationGroup="GUARDAR">*</asp:RequiredFieldValidator>
                            </b>
                        </td>
                        <td style="height: 23px">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td style="width: 132px; height: 23px;">
                            <asp:DropDownList ID="cboStip" runat="server" AutoPostBack="True" CssClass="txt"
                    ...
                    <tr>
                        <td style="width: 234px">
                            <b>
                                <asp:Label ID="Label7" runat="server" CssClass="Caption" Text="Modalidad de Contratación"></asp:Label>
                            </b>
                        </td>
                    ...
                    <tr>
                        <td style="width: 234px">
                            <b>
                                <asp:Label ID="Label4" runat="server" CssClass="Caption" Text="Dependencia que Genera la Necesidad"></asp:Label>
                            </b>
                        </td>
                        <td style="width: 132px">
                            &nbsp;
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:DropDownList ID="cboDep" runat="server" DataSourceID="ObjDep" DataTextField="nom_dep"
                                DataValueField="cod_dep" Width="85%">
                            </asp:DropDownList>
                        </td>
                        <td colspan="2">
                            &nbsp;
                    ...
                    <tr>
                        <td style="width: 234px">
                            <b>
                                <asp:Label ID="Label2" runat="server" CssClass="Caption" Text="Dependencia a Cargo de la Solicitud"></asp:Label>
                            </b>
                        </td>
                        <td style="width: 132px">
                            &nbsp;
                    ...
                    <tr>
                        <td colspan="2">
                            <b>
                                <asp:Label ID="Label3" runat="server" CssClass="Caption" Text="Contratista"></asp:Label>
                            </b>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td colspan="3" style="height: 25px">
                            <b>
                                <asp:Label ID="Label22" runat="server" CssClass="Caption" Text="Objeto a Contratar"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtObj"
                                    ErrorMessage="Debe digitar el Objeto a Contratar" ValidationGroup="GUARDAR">*</asp:RequiredFieldValidator>
                            </b>
                        </td>
                ...
                <table style="width: 90%">
                    <tr>
                        <td style="font-weight: 700" colspan="3">
                            <b>
                                <asp:Label ID="Label14" runat="server" CssClass="Caption" Text="Funcionario Encargado:"></asp:Label>
                                &nbsp;</b>
                        </td>
                        <td colspan="3">
                            &nbsp;
        ...
        <asp:ObjectDataSource ID="ObjDepDel" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetDelbySoloUser" TypeName="Dependencias"></asp:ObjectDataSource>
        ...
        <asp:ObjectDataSource ID="ObjSubTipos" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetByTipo" TypeName="SubTipos" InsertMethod="Insert" UpdateMethod="Update">
            <UpdateParameters>
        ...
        <asp:UpdatePanel runat="server" ID="Updmp" UpdateMode="Conditional">
            <ContentTemplate>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td class="style1" style="width: 128px">
                                    <asp:Label ID="Label1" runat="server" ForeColor="White" Text="Buscar Solicitud" Font-Bold="True"></asp:Label>
                                </td>
                ...
                <ajaxToolkit:ModalPopupExtender ID="ModalPopupSolicitudes" runat="server" TargetControlID="Button2"
                    BackgroundCssClass="modalBackground" PopupControlID="PanelSolicitudes" DropShadow="True"
                    CancelControlID="BtnCerrar1" PopupDragHandleControlID="Panel2">
                </ajaxToolkit:ModalPopupExtender>
            </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <asp:Panel ID="PanelOperaciones" runat="server" BackColor="White" Width="379px">
            ...
            <table style="width: 376px;">
                    ...
                    <td style="width: 233px">
                        <asp:UpdatePanel ID="UpdFecReAbrir" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <cc1:CalendarExtender ID="Txt_FecRec_CalendarExtender" runat="server" Enabled="True"
                                    TargetControlID="Txt_FecRec">
                                </cc1:CalendarExtender>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 233px">
                        <asp:TextBox ID="Txt_ObsRec" runat="server" Width="228px" Height="85px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td style="width: 3px">
                        &nbsp;
                    </td>
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server" TargetControlID="Btn_Target"
            PopupControlID="PanelOperaciones" CancelControlID="BtnCerrar" BackgroundCssClass="modalBackground"
            DropShadow="True">
        </ajaxToolkit:ModalPopupExtender>
    </div>
</asp:Content>
