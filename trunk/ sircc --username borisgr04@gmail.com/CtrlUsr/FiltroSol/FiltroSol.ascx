<%@ Control Language="VB" AutoEventWireup="false" CodeFile="FiltroSol.ascx.vb" Inherits="CtrlUsr_FiltroSol_FiltroSol" %>
        ...
        <tr><td style="width: 20px">
            ...
            <td class="stylefp">
                            ...
                            <asp:CheckBox ID="ChkTproc" runat="server" AutoPostBack="True" 
                                Text="Modalidad de Contratación" Checked="True" />
        ...
        <tr>
            ...
            <td class="stylefp">
                            <asp:CheckBox ID="ChkDepP" runat="server" AutoPostBack="True" 
                                Text="Dependencia a Cargo de la Solicitud" />
