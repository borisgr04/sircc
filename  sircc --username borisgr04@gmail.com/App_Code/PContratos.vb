...
Public Class PContratos
    ...
    '<DataObjectMethodAttribute(DataObjectMethodType.Insert, True)> _
    'Public Function Insert(ByVal COD_TPRO As String, ByVal PRO_SEL_NRO As String, ByVal OBJ_CON As String, ByVal PRO_CON As String, ByVal PLA_EJE_CON As Decimal, ByVal DEP_CON As String, ByVal DEP_PCON As String, ByVal VIG_CON As Decimal, ByVal TIP_CON As String, ByVal STIP_CON As String, ByVal VAL_CON As Decimal, ByVal VAL_APO_GOB As Decimal, ByVal COD_SEC As String, ByVal TIP_FOR As String, ByVal NRO_PLA_CON As String, ByVal URG_MAN As String, ByVal EST_CONV As String, ByVal APL_GAC As String, ByVal LUG_EJE As String, ByVal idtOblig As DataTable, ByVal idtCDP As DataTable) As String
    '    'Me.Desconectar()
    ...
    '    'Try
    '    'Me.ComenzarTransaccion()
    '    querystring = "Insert Into PCONTRATOS (COD_TPRO, PRO_SEL_NRO, OBJ_CON, PRO_CON, PLA_EJE_CON, DEP_CON, DEP_PCON, VIG_CON, TIP_CON, STIP_CON, VAL_CON, VAL_APO_GOB, COD_SEC, TIP_FOR, NRO_PLA_CON,  LUG_EJE) Values(:COD_TPRO, :PRO_SEL_NRO,  :OBJ_CON, :PRO_CON, :PLA_EJE_CON, :DEP_CON, :DEP_PCON, :VIG_CON, :TIP_CON, :STIP_CON, :VAL_CON, :VAL_APO_GOB, :COD_SEC, :TIP_FOR, :NRO_PLA_CON, :LUG_EJE)"
    ...
    '    Me.AsignarParametroCadena(":DEP_PCON", DEP_PCON)
    '    Me.AsignarParametroCadena(":LUG_EJE", LUG_EJE)
    '    'Me.AsignarParametroCadena(":EST_CON", EST_CON)
    ...
    End Function
    'Public Function Update(ByVal PRO_SEL_NRO_PK As String, ByVal COD_TPRO As String, ByVal PRO_SEL_NRO As String, ByVal OBJ_CON As String, ByVal PRO_CON As String, ByVal PLA_EJE_CON As Decimal, ByVal DEP_CON As String, ByVal DEP_PCON As String, ByVal VIG_CON As Decimal, ByVal TIP_CON As String, ByVal STIP_CON As String, ByVal VAL_CON As Decimal, ByVal VAL_APO_GOB As Decimal, ByVal COD_SEC As String, ByVal TIP_FOR As String, ByVal NRO_PLA_CON As String, ByVal URG_MAN As String, ByVal EST_CONV As String, ByVal APL_GAC As String, ByVal LUG_EJE As String, ByVal idtOblig As DataTable, ByVal idtCDP As DataTable) As String
    '    'Me.Desconectar()
    ...
    '    'Try
    '    'Me.ComenzarTransaccion()
    '    querystring = "Update PCONTRATOS SET COD_TPRO=:COD_TPRO, PRO_SEL_NRO=:PRO_SEL_NRO, OBJ_CON=:OBJ_CON, PRO_CON=:PRO_CON, PLA_EJE_CON=:PLA_EJE_CON, DEP_CON=:DEP_CON, DEP_PCON=:DEP_PCON, VIG_CON=:VIG_CON, TIP_CON=:TIP_CON, STIP_CON=:STIP_CON, VAL_CON=:VAL_CON, VAL_APO_GOB=:VAL_APO_GOB, TIP_FOR=:TIP_FOR, NRO_PLA_CON=:NRO_PLA_CON,LUG_EJE=:LUG_EJE WHERE PRO_SEL_NRO=:PRO_SEL_NRO_PK"
    ...
    'Public Function Update(ByVal PRO_SEL_NRO_PK As String, _
    '                      ByVal COD_TPRO As String, ByVal PRO_SEL_NRO As String, _
    '                       ByVal OBJ_CON As String, _
    '                       ByVal DEP_CON As String, ByVal DEP_PCON As String, _
    '                       ByVal VIG_CON As Decimal, ByVal TIP_CON As String, _
    '                       ByVal STIP_CON As String) As String
    '    'Me.Desconectar()
    ...
    '    'Try
    '    'Me.ComenzarTransaccion()
    '    querystring = "Update PCONTRATOS SET COD_TPRO=:COD_TPRO, OBJ_CON=:OBJ_CON, PRO_CON=:PRO_CON, PLA_EJE_CON=:PLA_EJE_CON, DEP_CON=:DEP_CON, DEP_PCON=:DEP_PCON, VIG_CON=:VIG_CON, TIP_CON=:TIP_CON, STIP_CON=:STIP_CON WHERE PRO_SEL_NRO=:PRO_SEL_NRO_PK"
