<%@ Page Language="VB" Title="" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="PContratosCord.aspx.vb" Inherits="Consultas_Procesos_PContratosCord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    <div class="demoarea">
     ...
     <div class="demoheading">REPORTE DE PROCESOS</div>
        <uc1:FiltroPConP ID="FiltroPConP1" runat="server" />
