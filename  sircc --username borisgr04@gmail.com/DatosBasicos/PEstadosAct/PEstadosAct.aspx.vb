Imports System.Data
Partial Class DatosBasicos_PEstados_Act_Default
    Inherits PaginaComun

    Dim Obj As New PEstadosAct
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ...
                GridView2.DataBind()
                ExportGridView(GridView2, "ESTADOS ACTIVIDADES - SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                GridView2.DataSource = Obj.GetRecordsDB
                GridView2.DataBind()
                ExportGridView(GridView2, "ESTADOS DE ACTIVIDADES-SIRCC")
            Case "Nuevo"
                If FileUpload1.HasFile Then
                    SubirAchivo(FileUpload1.PostedFile)
                Else
                    Me.MsgResult.Text = Obj.Insert(Me.TxtCod.Text, Me.TxtNom.Text, "", Me.TxtColor.Text)
                End If
