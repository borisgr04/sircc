Imports System.Data
Partial Class DatosBasicos_Tip_Doc_Default
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper
            Case "Exportar"
                ...
                GridView2.DataBind()
                ExportGridView(GridView2, "TIPOS DE DOCUMENTOS - SIRCC")
            Case "Nuevo"
                Me.SubT.Text = "Nuevo..."
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("Cod_Tip").ToString
                    Me.txtNomNew.Text = tb.Rows(0)("Des_Tip").ToString
                    Me.CboEst.Text = tb.Rows(0)("Est_Tip").ToString
                    Me.Pk1 = tb.Rows(0)("Cod_Tip").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, txtNomNew.Text, CboEst.SelectedValue, Me.Cbo_Eta.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Pk1, Me.TxtCodNew.Text, txtNomNew.Text, CboEst.SelectedValue, Me.Cbo_Eta.SelectedValue)
        End Select
