<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Polizas.aspx.vb" Inherits="DatosBasicos_Polizas_Default" %>
...
<Columns>
<asp:TemplateField HeaderText="Código" SortExpression="Cod_pol"><FooterTemplate>
...
<ItemTemplate>
<asp:Label id="LbCod" runat="server" Text='<%# Bind("Cod_pol") %>' __designer:wfdid="w9"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Nombre de la Poliza" SortExpression="Nom_Pol"><FooterTemplate>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Cod_Pol" 
                    ...
                    <asp:TemplateField HeaderText="Código" SortExpression="Cod_pol">
                        <ItemTemplate>
                            <asp:Label ID="LbCod0" runat="server" __designer:wfdid="w9" 
                                Text='<%# Bind("Cod_pol") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre de la Poliza" SortExpression="Nom_Pol">
                        <ItemTemplate>
            ...
            <br />
            <asp:ObjectDataSource id="ObjTipos" runat="server" TypeName="Polizas" 
            ...
            <asp:Panel id="programmaticPopup2" runat="server" Width="433px" Height="306px" 
                CssClass="ModalPanel2"><asp:Panel id="programmaticPopupDragHandle2" 
                    ...
                    <DIV style="padding: 5px; VERTICAL-ALIGN: middle; width: 419px;"><DIV style="FLOAT: left">
                            Polizas</DIV><DIV style="FLOAT: right">
