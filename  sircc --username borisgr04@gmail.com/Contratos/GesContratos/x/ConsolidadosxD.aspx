...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function verDatos() {
                LeerDatos();
                alert(iVig_Con + iIde_Sup + iDep_Nec);
                alert('Ver Datos...');
                // prepare the data
                var source = {
                    datatype: "xml",
            ...
            function Consultar() {
                iVig_Con = $("#<%=CmbVig.ClientID %>").val();
                if ($("#<%=CmbDep.ClientID %>").val() != null) {
                    iDep_Nec = $("#<%=CmbDep.ClientID %>").val();
                }
                else {
                    iDep_Nec = '';
                }
                if ($('#<%=TxtIdeSup.ClientID %>').val() != null) {
                    iIde_Sup = $('#<%=TxtIdeSup.ClientID %>').val();
                }
                else {
                    iIde_Sup = '';
                }
                //verDetalle("",iVig_Con,iDep_Nec,iIde_Sup);
                jsonData = "{'Vigencia':'" + iVig_Con + "','Dep_Nec':'" + iDep_Nec + "','Ide_Sup':'" + iIde_Sup + "'}";
                $.ajax({
                    type: "POST",
                    url: "ConsolidadosxD.aspx/GetDatos",
                    ...
                    [
                        ...
                        alert('Actualizar tabla' + iVig_Con + iDep_Nec + iIde_Sup);
                        verTabla(sampleData, iVig_Con, iDep_Nec, iIde_Sup)
            ...
            function verTabla(sampleData, iVig_Con, iDep_Nec, iIde_Sup) {
                alert('Se invoca Dibujar Tabla' + Datos);
                if (Object.prototype.toString.call(sampleData) === '[object Array]') {
                    alert('Es un Vector' + sampleData[1].Estado);
                }
                // prepare the data
                ...
                $("#jqxgrid").bind('rowselect', function (event) {
                    ...
                    Estado = Datos[selectedRowIndex].Estado;
                ...
                $("#jqxgridD").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Fec.Final Estimada ', datafield: 'FECHAFINALPROB' },
            ...
            function verDetalle(iEstado, iVig_Con, iDep_Nec, iIde_Sup) {
    ...
    <fieldset id="regFiltro">
        ...
        <div id="form">
            ...
            <span id="botones">
                ...
                <input id="BtnGra" class="button_example" type="button" value="Ver Grafica"  />
                <input id="BtnDat" class="button_example" type="button" value="Ver Datos"  />
