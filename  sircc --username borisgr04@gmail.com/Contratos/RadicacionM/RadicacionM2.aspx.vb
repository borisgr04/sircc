...
Partial Class Contratos_RadicacionM2_Default
    ...
    Sub AbrirP()
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.TxtValOtros.Text = (dt.Rows(0)("val_con") - dt.Rows(0)("val_apo_gob")).ToString.Replace(",", ".")
            ...
            'Me.BtnAct.Enabled = False
            Try
                If String.IsNullOrEmpty(dt.Rows(0)("INTERVENTORIA").ToString) Then
                    CboDepSup.SelectedValue = dt.Rows(0)("dep_con").ToString
                Else
                    CboDepSup.SelectedValue = dt.Rows(0)("INTERVENTORIA").ToString
                End If
            Catch ex As Exception
                Dim c As String = ""
                Me.MsgResult.Text += ex.Message
