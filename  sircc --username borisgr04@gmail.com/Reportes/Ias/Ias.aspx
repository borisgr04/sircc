<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Ias.aspx.vb" Inherits="Reportes_Ias_Ias" %>
...
<table style="width: 99%;" cellpadding="5" 
        ...
        <tr>
        <td colspan="4">
        <asp:Label id="Tit" runat="server" CssClass="Titulo" >REPORTE ORGANISMOS DE CONTROL</asp:Label>
        </td>
        </tr>
        <tr>
