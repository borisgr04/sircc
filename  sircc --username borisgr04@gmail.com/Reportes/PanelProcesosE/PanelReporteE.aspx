<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PanelReporteE.aspx.vb" Inherits="Reportes_PanelProcesos_PanelReporteE" %>
...
<body>
    ...
    <div>
        ...
        Encargado
        <asp:TextBox ID="TxtEnc" runat="server" Enabled="false"></asp:TextBox>
    ...
    <asp:ObjectDataSource ID="ObjCrono" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="CboObl" Name="Clasificacion" 
                    PropertyName="SelectedValue" Type="String" />
                <asp:ControlParameter ControlID="TxtEnc" Name="Encargado" 
