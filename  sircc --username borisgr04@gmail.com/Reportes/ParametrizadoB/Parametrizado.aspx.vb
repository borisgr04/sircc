Imports System.Data
Partial Class Reportes_ParametrizadoB_Parametrizado
    ...
    Private Function Filtro() As String
        ...
        If (ChkEst0.Checked = True) Then
            Util.AddFiltro(cFiltro, "Estado='" + CboEstados.SelectedValue + "'")
        End If
    ...
    Protected Function SqlG() As String
        Dim strsql As String = ""
        Dim cFiltro As String = Filtro()

        If Me.rdGroup.SelectedValue = "Rpt_Gra" Then
            strsql = "Select Dependencia,Estado,Count(*) vcontratos_Sinc_p  " + cFiltro + " Group by Dependencia,Estado"
        End If
