...
Partial Class CtrlUsr_CalenProg_CalenProgl
...
#Region "Eventos del control"
    ...
    'Private Property TipoProc As String
    '    Get
    '        Return Session("TipoProc")
    '    End Get
    '    Set(ByVal value As String)
    '        Session("TipoProc") = value
    '    End Set
    'End Property
...
#Region "Propiedades de Interacción"
    ...
    Public Property Num_Proc As String
        ...
        End Set
        Get
            Return HdNumProc.Value 'ViewState("Num_Proc")
        End Get
    End Property
...
#Region "Calendario"
    ...
    Function GetEventData(ByVal startDate As DateTime, ByVal endDate As DateTime) As DataTable
        ...
        Dim dtEvent As DataTable = Obj.GetCronograma(startDate, endDate, Me.Num_Proc)
...
#End Region
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim FechaF As Date = CStr(DirectCast(e.Row.DataItem, DataRowView)("FechaF"))
            Dim IS_FINAL As String = CStr(DirectCast(e.Row.DataItem, DataRowView)("IS_FINAL"))
            Dim NOM_EST As String = CStr(DirectCast(e.Row.DataItem, DataRowView)("NOM_EST"))
            If FechaF < Now Then
                If IS_FINAL = "SI" Then
    ...
    Sub Actualizar_Crono()
        GridView1.DataSource = obj.GetRecordsRPT(Num_Proc)
        GridView1.DataBind()
        Cargar_Dias()
    ...
    Protected Sub rdTabla_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rdTabla.CheckedChanged
        If rdTabla.Checked = True Then
            ...
            GridView1.DataSource = obj.GetRecordsRPT(Me.Num_Proc)
            GridView1.DataBind()
        End If
    End Sub
