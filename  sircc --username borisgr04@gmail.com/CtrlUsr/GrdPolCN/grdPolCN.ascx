<%@ Control Language="VB" AutoEventWireup="false" CodeFile="grdPolCN.ascx.vb" Inherits="CtrlUsr_grdPolC_grdPolCN" %>
    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:CommandField DeleteText="Eliminar" SelectImageUrl="~/images/eliminar.png" ShowDeleteButton="True" />
        </Columns>
    ...
    <asp:ObjectDataSource ID="ObjPol" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetbyPk" TypeName="PolizasContratos">
        <SelectParameters>
            <asp:ControlParameter ControlID="HiddenField1" Name="Num_Proc" PropertyName="Value"
                Type="String" />
            <asp:ControlParameter ControlID="HiddenField2" Name="Grupo" PropertyName="Value"
                Type="String" />
        </SelectParameters>
