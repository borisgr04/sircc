Imports System.Data
Partial Class CtrlUsr_FiltroContratos_FiltroContratos
    Inherits CtrlUsrComun

    ReadOnly Property strFiltro As String
        Get
            Return Sql()
        End Get
    End Property
    ReadOnly Property strFiltroSinOrder As String
        Get
            Return SqlSinOrder()
        End Get
    End Property
    Protected Function SqlSinOrder() As String
        ...
        If Me.rdGroup.SelectedValue = "Pol_Con" Then
            ...
            strsql = "SELECT * FROM vcontratos_Sinc_p_pol c  " + cFiltro + " ORDER BY numero, cod_pol"
