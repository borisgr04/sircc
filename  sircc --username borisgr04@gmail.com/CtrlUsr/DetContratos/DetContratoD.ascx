<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DetContratoD.ascx.vb" Inherits="Controles_DetContratoD" %>
            <table >
                <tr>
                    <td >
                ...
                <tr>
                    <td colspan="6">
                        <asp:DetailsView ID="DtPCon" runat="server" AutoGenerateRows="False" 
                            ...
                            <EmptyDataTemplate>
                                <br />
                                El Contrato no existe o pertenece a una Delegación de la cual no esta 
                                autorizado.
                            </EmptyDataTemplate>
