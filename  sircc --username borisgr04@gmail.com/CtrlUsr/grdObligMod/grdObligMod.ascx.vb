Imports System.Data
Partial Class CtrlUsr_grdOblig_grdObligMod
    ...
    Private obj As New Modificaciones
    ...
    Property Num_Sol_Adi() As String
        Set(ByVal value As String)
    ...
    Private Function GetRecords() As DataTable
        ...
        dt = obj.GetMod_Oblig(Num_Sol_Adi)
        Return dt
    End Function
    ...
    Protected Sub RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grd.RowCommand
        If e.CommandName.Equals("AddNew") Then
            ...
            Else
                Me.MsgResult.Text = obj.InsertObligaciones(Me.Num_Sol_Adi, txtNewOblig.Text, Me.Num_Proc)
    ...
    Protected Sub RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles grd.RowDeleting
        ...
        Me.MsgResult.Text = obj.DeleteObligaciones(Me.grd.DataKeys(e.RowIndex).Values(0).ToString(), Me.Num_Sol_Adi)
        MsgBox(MsgResult, obj.lErrorG)
    ...
    Protected Sub RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles grd.RowUpdating
        ...
        If txtOblig.Text = "" Then
            ...
            MsgBoxAlert(MsgResult, obj.lErrorG)
        Else
            Me.MsgResult.Text = obj.UpdateObligaciones(Me.Num_Sol_Adi, txtOblig.Text, Me.grd.DataKeys(e.RowIndex).Values(0).ToString())
            MsgBox(MsgResult, obj.lErrorG)
    ...
    Protected Sub ChkModOblig_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ChkModOblig.CheckedChanged
        MsgResult.Text = obj.Tras_Oblig(Me.Num_Proc, Me.Num_Sol_Adi, Util.invN1_0(Me.ChkModOblig.Checked))
        Me.Enabled = ChkModOblig.Checked
        Me.LlenarGrid()
    End Sub
End Class
