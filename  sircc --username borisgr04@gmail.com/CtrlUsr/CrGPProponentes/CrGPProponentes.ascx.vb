Imports System.Data
Partial Class CtrlUsr_CrProponentes_CrProponentes
...
#End Region
        ...
        Select Case Me.Oper
            ...
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Pk1, Me.TxtNit.Text, Me.Num_Proc, CDate(TxtFecProp.Text).ToShortDateString, TxtValProp.Text, TxtApe1.Text, _
                                             Me.TxtDir.Text, Me.TxtTel.Text, Me.TxtEma.Text, Me.TxtApe2.Text, Me.TxtNom1.Text, Me.TxtNom2.Text, Me.TxtNom.Text, _
                                             Me.CbTdoc.SelectedValue, Me.TxtLugExp.Text, "AC", Me.TxtObs.Text, Me.TxtNumFolio.Text, Me.TxtDver.Text, Me.TxtIdRepLeg.Text, Me.TxtRepLeg.Text, Me.TxtMun.Text, Me.Grupo, TxtDenominacion.Text, TxtAportes.Text)
                MsgBox(MsgResult, Obj.lErrorG)
        End Select
    ...
    Protected Sub TxtNit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtNit.TextChanged
        ...
        Dim dt As DataTable = obj.GetbyPk(TxtNit.Text, Num_Proc, Grupo)
    ...
    Public Sub Editar()
        ...
        Dim tb As DataTable = obj.GetbyPk(Nit, Num_Proc, Grupo)
